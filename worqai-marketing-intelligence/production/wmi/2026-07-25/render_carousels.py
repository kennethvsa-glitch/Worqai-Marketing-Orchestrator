"""
Render all 6 carousels (3 dark, 3 light) from HTML to PNG slides and build individual contact sheets.
"""
import os
import sys
...
def main():
    with sync_playwright() as p:
        for html_file, out_dir in CAROUSELS:
            render_carousel(p, html_file, out_dir)
    print("\n[SUCCESS] All 6 carousels rendered successfully!")
