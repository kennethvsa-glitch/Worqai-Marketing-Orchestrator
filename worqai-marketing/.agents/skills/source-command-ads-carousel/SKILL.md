---
name: "source-command-ads-carousel"
description: "Full ad carousel pipeline — brief → copy → HTML → design system → PNG → ZIP."
---

# source-command-ads-carousel

Use this skill when the user asks to run the migrated source command `ads-carousel`.
...
## Final Check
   ...
   - No AI slop in copy (run anti-slop sweep from `.Codex/rules/anti-slop.md`)
