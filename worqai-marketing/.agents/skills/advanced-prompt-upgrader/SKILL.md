...
description: >
  ...
  chat, Codex, API, agents, or RAG systems. Use when the user shares a draft prompt
...
- User wants variants for different environments (chat, API, Codex, RAG)
...
4. **Target environment** — Codex chat, Codex, API, RAG system, multi-agent
