# Batch 1 v2 — Carousel Reframe Specification

## Source Files
Location: `production/Carousels to remake/priority 1/Batch 1/`

| # | File | Current Brand | Theme |
|---|------|---------------|-------|
| 1 | `carousel_0-a-4-entrevistas_crimson.html` | WorqAI | ☀️ **LIGHT** |
| 2 | `carousel_0a4-entrevistas_beyond-elite.html` | WorqAI | ☀️ **LIGHT** |
| 3 | `carousel_0a4-entrevistas_clean-saas.html` | WorqAI | 🌙 **DARK** |
| 4 | `carousel_amby-cr-demo_agency-pain.html` | amby (rewrite) | 🌙 **DARK** |
| 5 | `carousel_aplicar-usa-latam_worqai.html` | WorqAI | ☀️ **LIGHT** |
| 6 | `carousel_ats-cv_worqai-verde.html` | WorqAI | ☀️ **LIGHT** |
| 7 | `carousel_ats-data-dashboard_beyond-elite.html` | WorqAI | ☀️ **LIGHT** |
| 8 | `carousel_ats-espanol-bombas_worqai.html` | WorqAI | 🌙 **DARK** |
| 9 | `carousel_ats-latam_worqai-verde.html` | WorqAI | 🌙 **DARK** |
| 10 | `carousel_ats-rechaza-sin-leer_s29.html` | WorqAI | 🌙 **DARK** |

## Output Location
`production/Carousels to remake/priority 1/Batch 1/reframed/`

## Dark Theme (Carousels 3, 4, 8, 9, 10)
...
## Light Theme (Carousels 1, 2, 5, 6, 7)
